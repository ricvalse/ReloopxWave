...
// `flatten`/`inflate` vivono in `./override-bag`, condivise con l'editor del
// comportamento per-profilo: i profili sono un delta della **stessa** shape
// (`BotConfigSchema`), quindi due implementazioni divergenti produrrebbero bag
// che il resolver legge in modo diverso.
